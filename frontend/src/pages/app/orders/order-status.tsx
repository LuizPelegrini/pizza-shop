...
const statusMap: Record<Status, { text: string, element: () => ReactNode }> = {
  pending: {
    text: 'Pending',
    element: () => <span className="size-2 rounded-full bg-slate-400" />
  },
  processing: {
    text: 'Processing',
    element: () => <span className="size-2 rounded-full bg-amber-500" />
  },
  canceled: {
    text: 'Canceled',
    element: () => <span className="size-2 rounded-full bg-rose-500" />
  },
  delivered: {
    text: 'Delivered',
    element: () => <span className="size-2 rounded-full bg-emerald-500" />
  },
  delivering: {
    text: 'Delivering',
    element: () => <span className="size-2 rounded-full bg-amber-500" />
